...
- [ ] Phase 4 complete — README with numbers, demo live, tag `v0.1.0` — *2026-09-18: three days run (structural counters 0 on all three, queue finding replicates); README, `crossday.md`, `docs/setup.md` and the vault copy in `docs/` done; 97 GB of data cleared with the small artifacts kept in the repo. Left: publish the demo, record the screencast, tag*
